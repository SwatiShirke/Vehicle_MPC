function f_vector = tire_forces(params, z, delta, ax, ay, deccel)
...
Fz_front = ((weight_front * params.m * params.g * params.b) - load_transfer_longitudinal - 0 * params.h) / params.l;   % Force on each front tire
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Slips = caculate_slip(params, z,deccel);
